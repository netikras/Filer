...
@ControllerAdvice
public class NotOpenExceptionHandler {
	
	@ExceptionHandler(NotOpenException.class)
	public @ResponseBody ErrorBody notOpenError (HttpServletResponse response, HttpServletRequest request, Exception exception) {
